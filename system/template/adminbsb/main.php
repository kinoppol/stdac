...
<body class="theme-red">
    ...
    <nav class="navbar">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php print site_url(); ?>"><?php print $systemSubTitle; ?> - <?php print $systemTitle; ?></a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                    ...
                    <?php
                        print gen_main_menu($menu_id='sidebar-nav', $menu, $def=NULL,$class='sidebar-nav','เมนูหลัก');
                    ?>
            </div>
            <!-- #Menu -->
            <!-- Footer -->
    ...
    <script src="<?php print $componentURL; ?>plugins/jquery-countto/jquery.countTo.js"></script>

    <script src="<?php print $componentURL; ?>plugins/raphael/raphael.min.js"></script>
    <script src="<?php print $componentURL; ?>plugins/morrisjs/morris.js"></script>
